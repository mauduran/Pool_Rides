...
import 'package:pool_rides/bloc/create-trip-bloc/createtrip_bloc.dart';
...
class _CreateTripPageState extends State<CreateTripPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        _bloc = CreateTripBloc();
        return _bloc;
      },
      child: BlocConsumer<CreateTripBloc, CreateTripState>(
        listener: (context, state) {
          if (state is CreatedTripState) {
          ...
          } else if (state is CreatedTripErrorState) {
            ScaffoldMessenger.of(context)
              ..hideCurrentSnackBar()
              ..showSnackBar(
                SnackBar(
